...
with open("dotocdo.txt", "w") as dotocdo_file:
...
with open("dotocdo.txt", "r") as dotocdo_file, open("luutocdo.txt", "r") as temptocdo_file, open("chenhlech.txt", "w") as chenhlech_file:
